<template>
    <div>
        <div style="display: flex; justify-content: flex-end;">
            <el-button @click="goHome" color="#409EFF" style="color: white">返回主页</el-button>
        </div>
        ...
        <div class="grid-container">
            ...
            <div class="upload-and-table-container">
                ...
                <div class="upload-container">
                    ...
                    <ImgUpload @confirmUpload="confirmUpload" @onCancel="onCancel" :disabled="uploadCompleted"
            ...
            <!-- 原来的检测信息表格 -->
            <div v-if="showResult" class="result-list-container" v-loading="loading" element-loading-text="结果拉取中..."
                element-loading-background="rgb(255,255,255)">
...
.table-container {
    ...
    /* 如果需要垂直居中，通常设置为 column，但这里你可能想要 row */
    align-items: center;
    /* 垂直居中 */
    justify-content: center;
    /* 水平居中（如果 flex-direction 是 row）*/

    /* 添加边框让他好看一点.. */
    border: 1px solid #4f636f;
    /* 边框颜色和粗细 */
    border-radius: 15px;
    /* 圆角 */
    box-shadow: 0 4px 8px rgba(73, 71, 71, 0.463);
    /* 阴影 */
    padding: 10px;
    /* 内边距 */
}
